...
Дизайн — **Material 3 Expressive** (тёмная/светлая темы на базе M3 color-roles, крупные радиусы,
мягкие тени/elevation, tonal-кнопки), фон — блуждающие размытые круги,
